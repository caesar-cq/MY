...
-- @Last modified by:   Emile Zhai
-- @Last modified time: 2017-01-04 16:37:42
...
-- 本地函数变量
--------------------------------------------------------------------------------------------------------------------------------------------
local _BUILD_ = "20170104"
local _VERSION_ = 0x2006800
...
do local AddonInfo = SetmetaReadonly({
	...
	tAuthor         = {
		...
		[1898367] = string.char( 0xDC, 0xF8, 0xD2, 0xC1, 0x40, 0xB0, 0xD7, 0xB5, 0xDB, 0xB3, 0xC7 ), -- 引仙水榭
